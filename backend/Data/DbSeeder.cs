...
public static class DbSeeder
{
    public static void Seed(ApplicationDbContext context)
    {
        ...
        {
            new() { EmployeeId = "FP-2024-897", Name = "Himeshwar", Email = "himeshwar.s@firstpay.com", Role = "Senior Software Engineer", Department = "Engineering", BudgetLimit = 5000.00m, SpentAmount = 0.00m, AvatarUrl = "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=256&auto=format&fit=crop", ManagerId = "FP-2024-001" },
            new() { EmployeeId = "FP-2024-111", Name = "ghiri", Email = "ghiri@firstpay.com", Role = "Employee", Department = "Engineering", BudgetLimit = 5000.00m, SpentAmount = 1200.00m, AvatarUrl = "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=256&auto=format&fit=crop", ManagerId = "FP-2024-001" },
            new() { EmployeeId = "FP-2024-912", Name = "Aisha Rahman", Email = "aisha.r@firstpay.com", Role = "Employee", Department = "Engineering", BudgetLimit = 5000.00m, SpentAmount = 2500.00m, AvatarUrl = "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=256&auto=format&fit=crop", ManagerId = "FP-2024-001" },
            ...
            new() { EmployeeId = "FP-2024-340", Name = "Sarah Jenkins", Email = "sarah.j@firstpay.com", Role = "Employee", Department = "Sales", BudgetLimit = 5000.00m, SpentAmount = 4000.00m, AvatarUrl = "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=256&auto=format&fit=crop", ManagerId = "FP-2024-003" },
        ...
        var expensesData = new List<(Expense Expense, string EmployeeId)>
        {
            ...
            (new Expense { Id = "EXP-1005", Title = "Internet Reimbursement - June", Category = "Others", Date = "2026-06-30", Description = "Work from home high speed broadband connection reimbursement.", TotalAmount = 50.00m, Status = "Draft", Notes = "Approved and paid in June payroll cycle." }, "FP-2024-897"),
            (new Expense { Id = "EXP-1006", Title = "Client Lunch meeting", Category = "Meals & Entertainment", Date = "2026-06-18", Description = "Business meal with prospects from FinTech Corp discussing payment gateway integration.", TotalAmount = 180.00m, Status = "Draft", Notes = "Receipt verified. Business justification acceptable." }, "FP-2024-897"),
            (new Expense { Id = "EXP-1007", Title = "Udemy - GoLang Microservices Course", Category = "Others", Date = "2026-05-12", Description = "Online video course for backend architecture scaling upskilling.", TotalAmount = 25.00m, Status = "Draft", Notes = "Reimbursed under self-learning allowance budget." }, "FP-2024-897"),
            (new Expense { Id = "EXP-1008", Title = "Dell USB-C Monitor Docking Hub", Category = "Office Supplies", Date = "2026-05-24", Description = "Multiport adapter for workstation dual monitor display setup.", TotalAmount = 110.00m, Status = "Draft" }, "FP-2024-897"),
            (new Expense { Id = "EXP-1009", Title = "GitHub Copilot Individual - Q2", Category = "Software & SaaS", Date = "2026-04-01", Description = "AI programming assistant quarterly license subscription.", TotalAmount = 30.00m, Status = "Draft", Notes = "Paid. Direct corporate credit card reconciliation." }, "FP-2024-897"),
            (new Expense { Id = "EXP-1010", Title = "Local Uber Rides to Client Site", Category = "Travel", Date = "2026-04-15", Description = "Commute fares for design reviews with API clients in Gurugram.", TotalAmount = 45.00m, Status = "Draft" }, "FP-2024-897"),
            ...
            (new Expense { Id = "EXP-1012", Title = "Monthly Broadband Internet - Feb", Category = "Others", Date = "2026-02-28", Description = "WFH monthly broadband connectivity subscription fee.", TotalAmount = 50.00m, Status = "Draft" }, "FP-2024-897"),
            (new Expense { Id = "EXP-1013", Title = "IntelliJ IDEA Professional annual subscription", Category = "Software & SaaS", Date = "2026-02-14", Description = "Annual developer tool license fee.", TotalAmount = 249.00m, Status = "Draft", Notes = "Approved under software department pre-cleared tool budget." }, "FP-2024-897"),
            ...
            (new Expense { Id = "EXP-1016", Title = "Local Cab Fares to Airport", Category = "Travel", Date = "2026-06-10", Description = "Travel cab for business travel to Delhi Airport.", TotalAmount = 75.00m, Status = "Draft" }, "FP-2024-897"),
            (new Expense { Id = "EXP-1017", Title = "Client Tea & Snacks Catering", Category = "Meals & Entertainment", Date = "2026-03-25", Description = "Catered refreshments for external clients during design discussions.", TotalAmount = 40.00m, Status = "Draft" }, "FP-2024-897"),
